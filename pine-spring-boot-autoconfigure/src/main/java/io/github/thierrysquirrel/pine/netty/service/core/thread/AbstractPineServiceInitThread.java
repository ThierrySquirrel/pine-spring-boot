...
package io.github.thierrysquirrel.pine.netty.service.core.thread;
...
public abstract class AbstractPineServiceInitThread implements Runnable {
    ...
    protected AbstractPineServiceInitThread(ThreadPoolExecutor pingServiceBusinessThreadPool, String pineServiceUrl) {
